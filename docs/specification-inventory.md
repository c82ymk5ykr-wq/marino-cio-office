...
| Required source, review, freshness, and durable persistence gates control `complete` | [Universe completion gates](universe-completion-gates.md), [report schema](../schemas/v1/report-manifest.schema.json), and [daily report template](../templates/daily-decision-report.md) | Validator rejects zero-denominator and contradictory complete claims |
